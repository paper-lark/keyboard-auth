...
import { KeyboardEvent } from '../api/__generated__/authenticator_pb';
...
describe('ProtoUtils', () => {
    describe('keyboard event mapper', () => {
        it('should map key press correctly', () => {
            ...
            expect(actual!.getKeyboard()!.getType()).toBe(KeyboardEvent.EventType.KEYDOWN);
        ...
        it('should map key release correctly', () => {
            ...
            expect(actual).toBeDefined();
            expect(actual!.getKeyboard()).toBeDefined();
            expect(actual!.getKeyboard()!.getType()).toBe(KeyboardEvent.EventType.KEYUP);
            expect(actual!.getKeyboard()!.getKey()).toBe('f');
            expect(actual!.getKeyboard()!.getTs()).toBeDefined();
    ...
    describe('authentication event mapper', () => {
        it('should map correctly', () => {
            ...
            const actual = ProtoUtils.mapAuthEventToProto(
                login,
                token
            );
